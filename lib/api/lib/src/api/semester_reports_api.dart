...
class SemesterReportsApi {

  final Dio _dio;

  final Serializers _serializers;

  const SemesterReportsApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<SemesterReportDto>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<SemesterReportDto>>> apiSemesterReportsGet({ 
    String? schoolUserId,
    ...
    final _path = r'/api/SemesterReports';
    ...
    BuiltList<SemesterReportDto>? _responseData;
    ...
    return Response<BuiltList<SemesterReportDto>>(
      data: _responseData,
