...
class OAuthApi {
  ...
  Future<Response<void>> apiPluginsSchulwareAccountsAccountIdAuthOauthCallbackPost({ 
    ...
    final _path = r'/api/plugins/schulware/accounts/{accountId}/auth/oauth/callback'.replaceAll('{' r'accountId' '}', encodeQueryParameter(_serializers, accountId, const FullType(String)).toString());
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiPluginsSchulwareAccountsAccountIdAuthOauthUrlGet({ 
    required String accountId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/plugins/schulware/accounts/{accountId}/auth/oauth/url'.replaceAll('{' r'accountId' '}', encodeQueryParameter(_serializers, accountId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
