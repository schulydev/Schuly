...
class SchoolUsersApi {

  final Dio _dio;

  final Serializers _serializers;

  const SchoolUsersApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<SchoolUserDto>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<SchoolUserDto>>> apiSchoolUsersGet({ 
    ...
    final _queryParameters = <String, dynamic>{
      if (applicationUserId != null) r'applicationUserId': encodeQueryParameter(_serializers, applicationUserId, const FullType(String)),
    };
    ...
    BuiltList<SchoolUserDto>? _responseData;
    ...
    return Response<BuiltList<SchoolUserDto>>(
      data: _responseData,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiSchoolUsersIdDelete({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/SchoolUsers/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SchoolUserDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SchoolUserDto>> apiSchoolUsersIdGet({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    SchoolUserDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SchoolUserDto),
      ) as SchoolUserDto;
