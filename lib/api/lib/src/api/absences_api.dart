...
class AbsencesApi {
  ...
  const AbsencesApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<AbsenceDto>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<AbsenceDto>>> apiAbsencesGet({ 
    ...
    BuiltList<AbsenceDto>? _responseData;
    ...
    return Response<BuiltList<AbsenceDto>>(
      data: _responseData,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiAbsencesIdDelete({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/Absences/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AbsenceDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AbsenceDto>> apiAbsencesSearchGet({ 
    String? absenceId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/Absences/search';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (absenceId != null) r'absenceId': encodeQueryParameter(_serializers, absenceId, const FullType(String)),
    };
    ...
    AbsenceDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AbsenceDto),
      ) as AbsenceDto;
