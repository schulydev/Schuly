...
class ExamsApi {
  ...
  const ExamsApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ExamDto>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ExamDto>>> apiExamsGet({ 
    ...
    BuiltList<ExamDto>? _responseData;
    ...
    return Response<BuiltList<ExamDto>>(
      data: _responseData,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiExamsIdDelete({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/Exams/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ExamDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ExamDto>> apiExamsSearchGet({ 
    String? examId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/Exams/search';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (examId != null) r'examId': encodeQueryParameter(_serializers, examId, const FullType(String)),
    };
    ...
    ExamDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ExamDto),
      ) as ExamDto;
