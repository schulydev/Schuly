...
class AgendasApi {
  ...
  const AgendasApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<AgendaEntryDto>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<AgendaEntryDto>>> apiAgendasGet({ 
    ...
    BuiltList<AgendaEntryDto>? _responseData;
    ...
    return Response<BuiltList<AgendaEntryDto>>(
      data: _responseData,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiAgendasIdDelete({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/Agendas/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AgendaEntryDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AgendaEntryDto>> apiAgendasSearchGet({ 
    String? agendaEntryId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/Agendas/search';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (agendaEntryId != null) r'agendaEntryId': encodeQueryParameter(_serializers, agendaEntryId, const FullType(String)),
    };
    ...
    AgendaEntryDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AgendaEntryDto),
      ) as AgendaEntryDto;
    ...
    return Response<AgendaEntryDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
